...
export default function About() {
  return (
    <section id="about" className="max-w-[1200px] mx-auto py-20 px-4 text-center bg-black ">
      <h2 className="text-3xl font-header mb-4 text-black">WE CAPTURE THE MOMENTS</h2>
